    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a genius address (e.g. SXywGBZBowrppUwwNUo1GCRDTibzJi7g2M)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::TransactionCommitFailed:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            QMessageBox::Ok, QMessageBox::Ok);
        break;
    case WalletModel::ReferenceTooLong:
        QMessageBox::warning(this, tr("Send Coins"),
            tr("Error: Reference is too long."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid genius address"));
        }
        else
        {
