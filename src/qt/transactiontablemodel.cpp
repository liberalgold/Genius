...
QString TransactionTableModel::formatReference(const TransactionRecord *wtx) const
{
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::ForegroundRole:
        // Non-confirmed (but not immature) as transactions are black
