// Copyright (c) 2014 The genius developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("genius-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("genius-smsg-pow"); // Make this thread recognisable
