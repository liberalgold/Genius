...
const string strMessageMagic = "X Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight <= 1000)
        nSubsidy = 100 * COIN; // PoW Total mint
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8); // Stable 0.000001% per year.
    if (fDebug && GetBoolArg("-printcreation"))
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "genius", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        const char* pszTimestamp = "Property 4 free";
        CTransaction txNew;
        txNew.nTime = 1421602069;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1421602069;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 85096 : 85096;
       ...
       printf("block.nNonce = %u \n", block.nNonce);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7bbf181ac56251eb0f9b154581657fb0c63643f3b5112ceeae201143e0905d64"));
        block.print();
